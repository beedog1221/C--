...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_GroundModel->Initialize(m_D3D->GetDevice(), L"../Project1/data/ground01.dds", "../Project1/data/ground.txt");
	...
	result = m_WallModel->Initialize(m_D3D->GetDevice(), L"../Project1/data/wall01.dds", "../Project1/data/wall.txt");
	...
	result = m_BathModel->Initialize(m_D3D->GetDevice(), L"../Project1/data/marble01.dds", "../Project1/data/bath.txt");
	...
	result = m_WaterModel->Initialize(m_D3D->GetDevice(), L"../Project1/data/water01.dds", "../Project1/data/water.txt");
...
bool GraphicsClass::Frame()
{
	...
	m_Camera->SetPosition(-4.0f, 3.3f, -3.5f);
...
void GraphicsClass::RenderRefractionToTexture()
{
	...
	clipPlane = D3DXVECTOR4(0.0f, -1.0f, 0.0f, m_waterHeight + 0.5f);
